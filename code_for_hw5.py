...
def d_mean_square_loss_th(x, y, th, th0):
    ...
    #Your code here
    return np.mean(d_lin_reg_th(x, y, th, th0), axis=1, keepdims=True)
...
def d_mean_square_loss_th0(x, y, th, th0):
    ...
    """
    #Your code here
    return np.mean(d_lin_reg_th0(x, y, th, th0), axis=1, keepdims=True)
...
def d_ridge_obj_th(x, y, th, th0, lam):
    ...
    """
    #Your code here
    return d_square_loss_th(x, y, th, th0) + 2*lam*th
...
def d_ridge_obj_th0(x, y, th, th0, lam):
    ...
    """
    #Your code here
    return d_square_loss_th0(x, y, th, th0)
...
def sgdTest():
    ...
    sgd(X, y, J, dJ, cv([0.0,0.0]), lambda i: 0.1, 1000)
    sgd(X, y, J, dJ, cv([-0.1,0.1]), lambda i: 0.1, 1000)
